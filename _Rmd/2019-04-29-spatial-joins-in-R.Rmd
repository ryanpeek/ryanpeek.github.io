...
```{r checkStations, echo=FALSE, eval=TRUE, purl=FALSE, warning=FALSE}
...
```{r ggPPTMapOut, eval=TRUE, echo=FALSE, out.height="100%", out.width="100%"}
...
```{r ggTEMPMapOut, eval=TRUE, echo=FALSE, out.height="100%", out.width="100%"}
